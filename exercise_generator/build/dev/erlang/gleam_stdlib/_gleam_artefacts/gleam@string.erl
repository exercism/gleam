...
do_from_utf_codepoints_impl(Utf_codepoints, Acc) ->
    case Utf_codepoints of
        [Head | Tail] ->
            do_from_utf_codepoints_impl(Tail, <<Acc/bitstring, Head/utf8>>);
