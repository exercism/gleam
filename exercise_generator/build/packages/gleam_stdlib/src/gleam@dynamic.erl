...
-spec map_errors(
    {ok, CMC} | {error, list(decode_error())},
...
) -> fun((dynamic()) -> {ok, {ok, CNH} | {error, CNJ}} |
    {error, list(decode_error())}).
...
-spec list(fun((dynamic()) -> {ok, CNO} | {error, list(decode_error())})) -> fun((dynamic()) -> {ok,
        list(CNO)} |
    {error, list(decode_error())}).
list(Decoder_type) ->
...
-spec optional(fun((dynamic()) -> {ok, CNT} | {error, list(decode_error())})) -> fun((dynamic()) -> {ok,
        gleam@option:option(CNT)} |
    {error, list(decode_error())}).
optional(Decode) ->
...
-spec element(
    integer(),
    fun((dynamic()) -> {ok, COJ} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, COJ} | {error, list(decode_error())}).
...
-spec tuple2(
    ...
    fun((dynamic()) -> {ok, CPG} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, {CPE, CPG}} | {error, list(decode_error())}).
...
) -> fun((dynamic()) -> {ok, {CPJ, CPL, CPN}} | {error, list(decode_error())}).
...
) -> fun((dynamic()) -> {ok, {CPQ, CPS, CPU, CPW}} |
    {error, list(decode_error())}).
...
) -> fun((dynamic()) -> {ok, {CPZ, CQB, CQD, CQF, CQH}} |
    {error, list(decode_error())}).
...
) -> fun((dynamic()) -> {ok, {CQK, CQM, CQO, CQQ, CQS, CQU}} |
    {error, list(decode_error())}).
...
) -> fun((dynamic()) -> {ok, gleam@map:map_(CQX, CQZ)} |
    {error, list(decode_error())}).
...
-spec any(list(fun((dynamic()) -> {ok, CRI} | {error, list(decode_error())}))) -> fun((dynamic()) -> {ok,
        CRI} |
    {error, list(decode_error())}).
any(Decoders) ->
...
-spec decode1(
    fun((CRM) -> CRN),
    fun((dynamic()) -> {ok, CRM} | {error, list(decode_error())})
...
-spec decode4(
    fun((CSE, CSF, CSG, CSH) -> CSI),
    fun((dynamic()) -> {ok, CSE} | {error, list(decode_error())}),
...
-spec decode5(
    ...
    fun((dynamic()) -> {ok, CSR} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CSS} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, CST} | {error, list(decode_error())}).
...
-spec decode6(
    fun((CTA, CTB, CTC, CTD, CTE, CTF) -> CTG),
...
-spec decode7(
    fun((CTO, CTP, CTQ, CTR, CTS, CTT, CTU) -> CTV),
...
-spec decode8(
    fun((CUE, CUF, CUG, CUH, CUI, CUJ, CUK, CUL) -> CUM),
    ...
    fun((dynamic()) -> {ok, CUH} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CUI} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CUJ} | {error, list(decode_error())}),
...
-spec decode9(
    fun((CUW, CUX, CUY, CUZ, CVA, CVB, CVC, CVD, CVE) -> CVF),
