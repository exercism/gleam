...
-export([format/1, term_to_binary/1, binary_to_term/1, unsafe_binary_to_term/1, get_line/1, system_time/1, erlang_timestamp/0, rescue/1, start_arguments/0, ensure_all_started/1, make_reference/0]).
...
-spec rescue(fun(() -> EKA)) -> {ok, EKA} | {error, crash()}.
rescue(Field@0) ->
